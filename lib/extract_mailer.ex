defmodule Extractor.ExtractMailer do
  ...
  def extractor_started(e_start_date, e_to_date, e_schedule, e_interval, camera_name) do
    Mailgun.Client.send_email @config,
      ...
      html: Phoenix.View.render_to_string(Extractor.EmailView, "extractor_started.html", start_date: e_start_date, to_date: e_to_date, interval: e_interval, schedule: e_schedule, camera_name: camera_name),
      text: Phoenix.View.render_to_string(Extractor.EmailView, "extractor_started.txt", start_date: e_start_date, to_date: e_to_date, interval: e_interval, schedule: e_schedule, camera_name: camera_name)
  end
